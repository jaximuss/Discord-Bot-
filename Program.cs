...
namespace Gamers_Hub_Butler__Code
{
    class Program
    {
        ...
        public async Task GamersHubb()
        {
            ...
            string token = "ODIwMDc3NjY1MzE3OTQ1Mzg0.YEv61w.wZHTyrF7MS1BLzgL0hpu5lFy3j0";//api token
        ...
        private async Task HandleCommandAsync(SocketMessage arg)    
        {
            ...
            int argPos = 0;
            if ( messageSent.HasStringPrefix("GH", ref argPos) || messageSent.HasStringPrefix("butler ", ref argPos))//how to call the bot
            {
